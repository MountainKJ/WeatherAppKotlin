package youqi.weatherapp.adapter
...
import youqi.weatherapp.R
import youqi.weatherapp.ctx
import youqi.weatherapp.domain.model.Forecast
...
class ForecastListAdapter(private val weekForecast: ForecastList, private val itemClick: (Forecast) -> Unit)
    ...
    override fun onBindViewHolder(holder: ViewHolder, postion: Int) {
        holder.bindForecast(weekForecast.dailyForecast[postion])
    }
